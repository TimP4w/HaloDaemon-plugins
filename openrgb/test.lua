...
return function(h)
  ...
  h:assert_eq(#controllers, 3, "three controllers enumerate")
  ...
  h:assert_eq(controllers[1].location.kind, "hid_path", "HID location maps to hid_path")
  h:assert_eq(controllers[1].location.path, "/dev/hidraw6", "HID path drops the prefix and NUL")
  ...
  h:assert_eq(controllers[3].location.kind, "opaque", "an unrecognized location stays opaque")
  h:assert_eq(controllers[3].location.value, "PCI: 0000:01:00.0", "opaque location is verbatim")
