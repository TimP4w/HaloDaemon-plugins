...
return {
  ...
  choice = {
    choices = {
      { key = "gain", label = "Microphone Gain", category = "Microphone", display = "inline",
        options = { { id = "0", label = "Low" }, { id = "1", label = "High" } } },
      { key = "sidetone", label = "Sidetone", category = "Microphone", display = "inline",
        options = { { id = "0", label = "Off" }, { id = "1", label = "Low" },
                    { id = "2", label = "Medium" }, { id = "3", label = "High" } } },
      { key = "nc_mode", label = "Mode", category = "Noise Cancelling", display = "inline",
        options = { { id = "0", label = "Off" }, { id = "1", label = "Transparent" },
                    { id = "2", label = "Noise Cancelling" } } },
      { key = "wireless_mode", label = "Wireless Mode", category = "Base Station", display = "inline",
        options = { { id = "0", label = "Maximum Speed" }, { id = "1", label = "Maximum Range" } } },
      { key = "auto_off", label = "Auto-Off Timeout", category = "Base Station", display = "list",
        options = { { id = "0", label = "Off" }, { id = "1", label = "1 min" },
                    { id = "2", label = "5 min" }, { id = "3", label = "10 min" },
                    { id = "4", label = "15 min" }, { id = "5", label = "30 min" },
                    { id = "6", label = "60 min" } } },
      { key = "screen_mode", label = "Screen Mode", category = "Base Station", display = "inline",
        options = { { id = "0", label = "Detailed" }, { id = "1", label = "Simple" } } },
      { key = "sonar_eq", label = "Sonar EQ", category = "Audio", display = "toggle",
        options = { { id = "0", label = "Off" }, { id = "1", label = "On" } } },
    },
  },

  range = {
    ranges = {
      { key = "mic_volume", label = "Microphone Volume", category = "Microphone",
        min = 1, max = 10, step = 1, default = 10 },
      { key = "mic_led_brightness", label = "LED Brightness", category = "Microphone",
        min = 10, max = 100, step = 10, default = 100 },
      { key = "nc_level", label = "Transparency Level", category = "Noise Cancelling",
